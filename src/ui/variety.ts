...
export class VarietyHUD {
  ...
  onStore:(slot:0|1)=>void=()=>{};onRetrieve:(uid:number)=>void=()=>{};onSlot:(slot:0|1)=>void=()=>{};onPerk:(id:PerkId)=>void=()=>{};
