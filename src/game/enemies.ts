export type EnemyKind='walker'|'runner'|'tank'|'spitter';
...
export const ENEMIES:Record<EnemyKind,EnemyDefinition>={
  ...
  runner:{name:'Corredor',hp:58,speed:3.35,radius:.42,damage:7,structure:10,baseDamage:14,interval:.85,stagger:.55,knockback:1.5,windup:.22,startNight:2,scaleX:.8,scaleY:.94,headY:1.72,headZ:.32,hint:'Rápido. Mantenha distância e uma rota de fuga.'},
